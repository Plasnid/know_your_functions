...
// ! now lets do a slightly more complicated function
...
/**
 * * Sometimes you might want the funtion to run automatically!
 * * To make this happen end the function with ()
 * * Check out the function below
 */

(function(){
    console.log("Tentacles are awesome");
})()


//! Function Expression
//* A functon expression is a function that is expressed or held by a variable
//* When a function lives in a variable
